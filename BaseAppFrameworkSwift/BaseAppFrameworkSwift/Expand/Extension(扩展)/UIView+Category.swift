...
extension UIView
{
    ...
    /// - Returns: UIView
    func loadNib() -> UIView {
        let nibs = Bundle.main.loadNibNamed(getXibName(), owner: nil, options: nil)
        return nibs!.first as! UIView
    }
     /// 获得Xib文件名
    private func getXibName() -> String {
        let clzzName:NSString = NSStringFromClass(self.classForCoder) as NSString
